...
import { IConfiguration } from './lib/utils/interfaces/configurations.interface'

const useEnvVars = (env = Updates.channel) => {
  const configuration: IConfiguration = useContext(ConfigurationContext)
  ...
  return {
    ...
    WS_GRAPHQL_URL: 'ws://localhost:8003/graphql',
