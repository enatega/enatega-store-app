    ...
    const renderTabBar = (props: any) => {
        ...
        return (
            <View style={styles.tabBar}>
                {props.navigationState.routes.map((route: { key: React.Key | null | undefined; title: string | number | boolean | Animated.Value | Animated.AnimatedInterpolation<string | number> | Animated.WithAnimatedObject<React.ReactElement<any, string | React.JSXElementConstructor<any>>> | Animated.WithAnimatedObject<Iterable<React.ReactNode>> | Animated.WithAnimatedObject<React.ReactPortal> | null | undefined; }, i: number) => {
