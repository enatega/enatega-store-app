...

                        {
                            ({ handleChange, handleBlur, handleSubmit, values, errors }) => {
                                ...
                                return <View className="mt-24 p-5 items-start gap-y-2">
                                    ...
                                    {/* Login Button */}
                                    <TouchableOpacity className="h-12 bg-green-500 rounded-3xl py-3 mt-10 w-full" onPress={() => handleSubmit()}>
                                        {isLogging ? <SpinnerComponent /> : <Text className="text-center text-white text-lg font-medium">
                                            Login
                                        </Text>}
                                    </TouchableOpacity>
                                </View>
